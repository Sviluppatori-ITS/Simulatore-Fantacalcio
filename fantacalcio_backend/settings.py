...
#     # "http://localhost:3000",  # porta dev React
#     "http://localhost:5173",  # porta dev di Vite React (modifica se cambi)
# ]
...
REST_FRAMEWORK = {
    ...
    #     # puoi aggiungere altri renderer ma NON BrowsableAPIRenderer
