        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nome del continente", max_length=100, unique=True
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        help_text="Codice ISO del continente", max_length=3, unique=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Continente di appartenenza",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Indica se il torneo è attivo"
                    ),
                ),
                (
                    "start_date",
                    models.DateField(
                        blank=True, help_text="Data di inizio del torneo", null=True
                    ),
                ),
                (
                    "end_date",
                    models.DateField(
                        blank=True, help_text="Data di fine del torneo", null=True
                    ),
                ),
                (
                    "logo",
                ...
                (
                    "teams",
                    models.ManyToManyField(
                        blank=True, related_name="tournaments", to="core.seasonteam"
                    ),
                ),
                (
                    "structure",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "win",
                    models.PositiveIntegerField(
                        default=0, help_text="Numero di vittorie"
                    ),
                ),
                (
                    "draw",
                    models.PositiveIntegerField(
                        default=0, help_text="Numero di pareggi"
                    ),
                ),
                (
                    "loss",
                    models.PositiveIntegerField(
                        default=0, help_text="Numero di sconfitte"
                    ),
                ),
                (
                    "win_penalty",
                    models.PositiveIntegerField(
                        default=0, help_text="Numero di vittorie ai rigori"
                    ),
                ),
                (
                    "loss_penalty",
                    models.PositiveIntegerField(
                        default=0, help_text="Numero di sconfitte ai rigori"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="team_tournament_rankings",
                        to="core.seasonteam",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tournament_rankings",
                        to="core.tournament",
                    ),
                ),
            ],
